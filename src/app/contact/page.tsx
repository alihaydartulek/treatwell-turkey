...
export const metadata: Metadata = {
  title: "Contact Us — TreatWell Turkey",
  description: "Get in touch with the TreatWell Turkey team.",
};
          ...
          <div className="flex flex-col gap-4 mb-10">
            ...
            >
              ...
              <div>
                ...
                <div className="text-sm text-blue-600">hello@treatwellturkey.com</div>
              </div>
            </a>
