  ...
  },
  {
    ...
    faqs: [
      ...
      },
      {
        ...
        answer:
          "This depends on your procedure. General guidelines: Hair transplant — 3–4 days (procedure day + 2-3 recovery days). Dental veneers/implants — 5–10 days. Bariatric surgery — 7–10 days (including hospital stay). Rhinoplasty — 7–10 days. IVF cycle — this varies significantly; many patients make 2 trips. Eye surgery (LASIK) — 3–4 days. Always confirm the recommended stay with your chosen clinic before booking flights, as individual recovery can vary.",
      },
      {
    ...
    faqs: [
      {
        ...
        answer:
          "TreatWell Turkey is an independent comparison and directory platform. We verify clinics, display their real Google ratings and pricing, and allow patients to contact them directly. We do not act as an intermediary or coordinator — there is no middleman between you and the clinic. You browse profiles, find a clinic you like, and contact them directly via WhatsApp or email from their profile page. We believe this is the most transparent and patient-friendly model.",
      },
      {
        question: "Is TreatWell Turkey free to use?",
        answer:
          "Yes, completely free for patients. We do not charge patients any fees, take any booking commission, or add any hidden costs to the clinic's prices. Clinics pay a listing fee to be featured on the platform. This is disclosed openly — it is how we keep the service free for patients. Our listings are not ranked by how much clinics pay us; rankings are based on verified patient ratings and accreditations.",
      },
      {
        question: "Do you take a commission when I book a clinic?",
        answer:
          "No. We have deliberately built a no-commission model. When you contact a clinic directly from our platform, we receive no payment related to your booking. Clinics pay a fixed monthly or annual listing fee to be on the platform — that fee is the same regardless of how many patients book through us. This removes the financial incentive to push you towards more expensive clinics.",
      },
      {
        question: "How are the Google ratings sourced?",
        answer:
          "The ratings displayed on TreatWell Turkey are sourced from publicly available Google Maps data. They are not curated, filtered, or modified by us. We clearly label all ratings as 'Google ratings' and include the review count so you can verify them independently on Google Maps. We also link directly to each clinic's Google Maps listing from their profile page.",
      },
      {
