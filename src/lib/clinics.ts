...
export const clinics: Clinic[] = [
  ...
  {
    id: 23,
    slug: "drgo-clinic-istanbul",
    name: "DRGO Clinic",
    city: "Istanbul",
    district: "Beşiktaş",
    tagline: "Aesthetic and plastic surgery in Istanbul led by European Board Certified surgeon Assoc. Prof. Dr. Güncel Öztürk.",
    description:
      "DRGO Clinic is an aesthetic and plastic surgery centre in Beşiktaş, Istanbul, led by Assoc. Prof. Dr. Güncel Öztürk, a European Board Certified Plastic Surgeon (EBOPRAS) and founder of the DRGO Group. The clinic focuses on facial and body aesthetic surgery — including rhinoplasty, facelift, neck lift, breast surgery, liposuction and body contouring — with an emphasis on natural proportions and personalised surgical planning. International patients are supported in several languages.",
    treatments: ["Rhinoplasty", "Facelift", "Neck Lift", "Eyelid Surgery", "Breast Augmentation", "Liposuction", "Body Contouring"],
    treatmentSlugs: ["cosmetic"],
    rating: 4.6,
    reviewCount: 44,
    googleRating: 4.6,
    ...
    phone: "+90 532 177 87 89",
    email: "info@guncelozturk.com",
    whatsapp: "+90 532 177 87 89",
    website: "https://www.guncelozturk.com",
    badge: "Board Certified",
    badgeColor: "bg-teal-100 text-teal-700",
    realClinic: true,
    highlights: [
      "Led by Assoc. Prof. Dr. Güncel Öztürk — European Board Certified (EBOPRAS)",
...

  {
    ...
    treatments: ["Hollywood Smile", "E-Max Veneers", "Zirconium Veneers", "Dental Implants", "All-on-4", "All-on-6", "Dental Crowns"],
    treatmentSlugs: ["dental"],
    rating: 4.8,
    reviewCount: 143,
    googleRating: 4.8,
    ...
    highlights: [
      ...
      "Hollywood Smile, E-max and zirconium veneers",
    ...
    doctors: [
      ...
      },
      {
        ...
        experience: 15,
        bio: "Oral surgeon specialising in surgical dentistry, dental implantation and maxillofacial procedures, with an emphasis on precision, patient safety and long-term functional stability.",
        initials: "CY",
      },
    ],
    reviews: [],
...

  {
    ...
    city: "Istanbul",
    district: "Beşiktaş",
    tagline: "A surgeon-led hair transplant centre in Istanbul, part of the DRGO Group founded by Assoc. Prof. Dr. Güncel Öztürk.",
    description:
      "HairNeva is a hair transplantation centre in Beşiktaş, Istanbul, founded and led by European Board Certified Plastic Surgeon Assoc. Prof. Dr. Güncel Öztürk, a member of the International Society of Hair Restoration Surgery (ISHRS). It specialises in DHI and Sapphire FUE techniques, along with beard, eyebrow and women's hair restoration. Packages include accommodation, VIP transfers, PRP support and long-term aftercare, with a lifetime warranty on transplanted grafts.",
    ...
    established: 2021,
    patientCount: "1,000+",
    accreditations: ["Turkish Ministry of Health", "ISHRS Member", "Health Tourism Authorised"],
    languages: ["English", "French", "German", "Russian", "Turkish", "Arabic", "Hindi"],
    phone: "+90 532 177 87 89",
    ...
    realClinic: true,
    highlights: [
      "Surgeon-led by Assoc. Prof. Dr. Güncel Öztürk — ISHRS member",
    ...
    doctors: [
      {
        name: "Assoc. Prof. Dr. Güncel Öztürk",
        title: "MD, FEBOPRAS",
        specialty: "Hair Restoration & Plastic Surgery",
        experience: 20,
        bio: "European Board Certified Plastic Surgeon and founder of HairNeva, and a member of the International Society of Hair Restoration Surgery (ISHRS). He brings a plastic surgery background to hairline design and long-term aesthetic planning.",
        initials: "GÖ",
      },
    ],
    reviews: [],
