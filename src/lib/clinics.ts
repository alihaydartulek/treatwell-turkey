...
export type Clinic = {
  ...
  rating: number;
  reviewCount: number;
  priceList?: { treatment: string; from: number }[];
  ratingSource?: string;
  googleRating?: number;
...
export const clinics: Clinic[] = [
  ...
  // ─── DRGO GROUP, ISTANBUL (added Sep 2026, partner clinics) ──────────────────

  {
    id: 23,
    slug: "dr-guncel-ozturk-istanbul",
    name: "Assoc. Prof. Dr. Güncel Öztürk",
    city: "Istanbul",
    district: "Beşiktaş",
    tagline: "The private aesthetic and plastic surgery practice of Assoc. Prof. Dr. Güncel Öztürk, a European Board Certified surgeon in Istanbul.",
    description:
      "This is the private medical practice of Assoc. Prof. Dr. Güncel Öztürk, a European Board Certified Plastic Surgeon (EBOPRAS) and founder of the DRGO Group. Based in Beşiktaş, Istanbul, the practice focuses on facial and body aesthetic surgery — including rhinoplasty, facelift, neck lift, eyelid surgery, breast augmentation and liposuction — with an emphasis on natural proportions and personalised surgical planning. International patients are supported in several languages.",
    treatments: ["Rhinoplasty", "Facelift", "Neck Lift", "Eyelid Surgery", "Breast Augmentation", "Liposuction"],
    treatmentSlugs: ["cosmetic"],
    rating: 4.6,
    reviewCount: 44,
    googleRating: 4.6,
    ...
    priceFrom: 4000,
    priceList: [
      { treatment: "Rhinoplasty", from: 7000 },
      { treatment: "Facelift", from: 10500 },
      { treatment: "Neck Lift", from: 9870 },
      { treatment: "Eyelid Surgery", from: 4000 },
      { treatment: "Breast Augmentation", from: 7970 },
      { treatment: "Liposuction", from: 6000 },
    ],
    established: 2012,
    patientCount: "1,000+",
    accreditations: ["Turkish Ministry of Health", "EBOPRAS", "ASPS Member", "ISAPS Member"],
    languages: ["English", "French", "German", "Russian", "Turkish", "Arabic", "Hindi"],
    phone: "+90 532 215 09 33",
    email: "info@guncelozturk.com",
    whatsapp: "+90 532 215 09 33",
    website: "https://www.guncelozturk.com",
    badge: "Board Certified",
    badgeColor: "bg-teal-100 text-teal-700",
    realClinic: true,
    highlights: [
      "European Board Certified Plastic Surgeon (EBOPRAS)",
      "Member of ASPS and ISAPS",
      "Focus on rhinoplasty, facial and breast aesthetic surgery",
    ...
    doctors: [
      {
        ...
        experience: 20,
        bio: "European Board Certified Plastic Surgeon and founder of the DRGO Group. He completed advanced training in rhinoplasty and facial aesthetics at Yale University and the University of Miami, holds the EBOPRAS qualification, and is a member of ASPS and ISAPS. His work focuses on facial harmony and natural, balanced results.",
        initials: "GÖ",
      },
    ],
    reviews: [],
  ...
  {
    id: 24,
    slug: "drgo-smile-istanbul",
    name: "DRGO Smile",
    city: "Istanbul",
    district: "Beşiktaş",
    tagline: "A cosmetic dentistry and smile-design clinic in Istanbul, part of the DRGO Group founded by Assoc. Prof. Dr. Güncel Öztürk.",
    description:
      "DRGO Smile is a dental clinic in Beşiktaş, Istanbul, part of the DRGO Group. It specialises in cosmetic dentistry and smile design — Hollywood Smile, E-max and zirconium veneers, and Digital Smile Design — alongside comprehensive dental care including implants, All-on-4 and All-on-6, oral surgery and full-mouth rehabilitation. International patients receive coordinated support from consultation through to aftercare.",
    treatments: ["Hollywood Smile", "E-Max Veneers", "Zirconium Crown", "Dental Implants", "All-on-4", "All-on-6"],
    treatmentSlugs: ["dental"],
    rating: 4.8,
    reviewCount: 143,
    googleRating: 4.8,
    ...
    priceFrom: 175,
    priceList: [
      { treatment: "Hollywood Smile", from: 3000 },
      { treatment: "E-Max Veneers", from: 300 },
      { treatment: "Zirconium Crown", from: 175 },
      { treatment: "Dental Implants", from: 300 },
      { treatment: "All-on-4", from: 6600 },
      { treatment: "All-on-6", from: 8150 },
    ],
    established: 2022,
    patientCount: "1,000+",
    accreditations: ["Turkish Ministry of Health", "Health Tourism Authorised"],
    languages: ["English", "French", "German", "Russian", "Turkish", "Arabic"],
    phone: "+90 546 529 06 81",
    email: "info@drgosmile.com",
    whatsapp: "+90 546 529 06 81",
    website: "https://drgosmile.com",
    badge: "Digital Smile Design",
    badgeColor: "bg-teal-100 text-teal-700",
    realClinic: true,
    highlights: [
      "Cosmetic dentistry and smile design with Digital Smile Design technology",
      "Hollywood Smile, E-max veneers and zirconium crowns",
      "Implants, All-on-4 and All-on-6, and full-mouth rehabilitation",
      "Part of the DRGO Group — Ministry of Health authorised for health tourism",
    ],
    doctors: [
      {
        name: "Dr. Bihter",
        ...
        experience: 15,
        bio: "Cosmetic dentist specialising in smile aesthetics, aesthetic restorations and veneers, with a focus on natural-looking smiles that complement each patient's facial features.",
        initials: "B",
      },
      {
        name: "Dr. Can",
        ...
        experience: 15,
        bio: "Dental surgeon specialising in surgical dentistry, dental implantation and oral surgical procedures, with an emphasis on precision, patient safety and long-term functional stability.",
        initials: "C",
      },
      {
        name: "Dr. Barış",
        ...
        experience: 20,
        bio: "Cosmetic dentist with 20 years of experience, specialising in smile aesthetics, aesthetic restorations and veneers, with a focus on natural-looking smiles that complement each patient's facial features.",
        initials: "B",
      },
    ],
    reviews: [],
  ...
  {
    id: 25,
    slug: "hairneva-istanbul",
    name: "HairNeva",
    city: "Istanbul",
    district: "Beşiktaş",
    tagline: "A hair transplant centre in Istanbul, part of the DRGO Group founded by Assoc. Prof. Dr. Güncel Öztürk.",
    description:
      "HairNeva is a hair transplantation centre in Beşiktaş, Istanbul, part of the DRGO Group founded by Assoc. Prof. Dr. Güncel Öztürk. It specialises in DHI and Sapphire FUE techniques, along with beard, eyebrow and women's hair restoration. Packages include accommodation, VIP transfers, PRP support and long-term aftercare, with a lifetime warranty on transplanted grafts.",
    treatments: ["Hair Transplant (DHI)", "Sapphire FUE Hair Transplant", "Unshaven Hair Transplant", "Women's Hair Transplant", "Beard Transplant", "Eyebrow Transplant", "PRP Therapy"],
    treatmentSlugs: ["hair-transplant"],
    rating: 4.9,
    reviewCount: 1133,
    googleRating: 4.9,
    googleReviewCount: 1133,
    priceFrom: 200,
    priceList: [
      { treatment: "DHI Hair Transplant", from: 3490 },
      { treatment: "Sapphire FUE Hair Transplant", from: 2990 },
      { treatment: "Unshaven Hair Transplant", from: 3490 },
      { treatment: "Women's Hair Transplant", from: 3490 },
      { treatment: "Beard Transplant", from: 3140 },
      { treatment: "Eyebrow Transplant", from: 2800 },
      { treatment: "PRP Therapy", from: 200 },
    ],
    established: 2017,
    patientCount: "1,000+",
    accreditations: ["Turkish Ministry of Health", "Health Tourism Authorised"],
    languages: ["English", "French", "German", "Russian", "Turkish", "Arabic", "Hindi"],
    phone: "+90 533 134 63 37",
    email: "info@hairneva.com",
    whatsapp: "+90 533 134 63 37",
    website: "https://www.hairneva.com",
    badge: "Top Rated",
    badgeColor: "bg-yellow-100 text-yellow-700",
    realClinic: true,
    highlights: [
      "Doctor-led hair restoration by an experienced medical team",
      "DHI and Sapphire FUE, plus beard, eyebrow and women's restoration",
      "Packages include hotel, VIP transfers, PRP and aftercare",
    ...
    doctors: [
      {
        name: "Dr. Barış",
        title: "MD",
        specialty: "Hair Transplantation Physician",
        experience: 10,
        bio: "A medical aesthetics and hair transplantation physician (Istanbul University–Cerrahpaşa, Faculty of Medicine) specialising in hair restoration, with expertise in DHI and FUE procedures, precise graft extraction, natural hairline design and individualised patient care.",
        initials: "B",
      },
      {
        name: "Dr. Hülya B.",
        ...
        experience: 20,
        bio: "An anesthesiologist (Istanbul University, Faculty of Medicine) responsible for supporting patient safety and comfort throughout procedures requiring anesthesia or sedation.",
        initials: "H",
      },
      {
        name: "Dr. Özen G.",
        ...
        experience: 30,
        bio: "A dermatologist (Istanbul University–Cerrahpaşa, Faculty of Medicine) with a focus on hair and scalp health, contributing to the assessment and management of patients throughout their hair restoration journey.",
        initials: "Ö",
      },
    ],
    reviews: [],
